<?php
namespace Checkit\VerowaApiconnector\Userfuncs;
...
class Tca {
	...
	/**
	 * This method creates custom titles for the records of the tx_verowaapiconnector_domain_model_event table
	 *
    ...
    /**
	 * This method creates custom titles for the records of the tx_verowaapiconnector_domain_model_layer table
	 *
	 * @param array $parameters Parameters used to identify the current record
	 * @param object $parentObject Calling object
	 * @return void
	...
	/**
	 * This method creates custom titles for the records of the tx_verowaapiconnector_domain_model_room table
	 *
	 * @param array $parameters Parameters used to identify the current record
	 * @param object $parentObject Calling object
	 * @return void
	...
	/**
	 * This method creates custom titles for the records of the tx_verowaapiconnector_domain_model_person table
	 *
	 * @param array $parameters Parameters used to identify the current record
	 * @param object $parentObject Calling object
	 * @return void
