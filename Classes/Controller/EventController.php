...
class EventController extends ActionController
{
	 ...
	 * eventRepository
	 *
		* @var \Checkit\VerowaImportapi\Domain\Repository\EventRepository
		*/
	protected $eventRepository = null;

	/**
	 * @param \Checkit\VerowaImportapi\Domain\Repository\EventRepository $eventRepository
		*/
	public function injectEventRepository(\Checkit\VerowaImportapi\Domain\Repository\EventRepository $eventRepository)
	{
	 ...
	 * action show
		...
		* @return string|object|null|void
		*/
	public function showAction(\Checkit\VerowaImportapi\Domain\Model\Event $event)
	{
